...
\author{ Shivanshu%<-this  stops a space
\thanks{*The author is with the Department
of Artificial Intelligence, Indian Institute of Technology, Hyderabad
502285 India e-mail:  ai21btech11027@iith.ac.in. }% <-this % stops a space
...
\item Plot $x(t)$. \\
	\solution This the required plot. \\
	\begin{figure}[!ht]
		\centering
	   ...
	   \label{fig:1.1}
	   \end{figure}
	   The required plot can also be downloaded using the given link 
	   \begin{lstlisting}
			wget link_1
	   \end{lstlisting}
...
\solution 
\begin{align}
	x(t+\frac{1}{2f_0}) &= A_0\abs{\sin\brak{2\pi f_0\brak{t + \frac{1}{2f_0}}}} \\
	&= A_0\abs{\sin\brak{2\pi f_0t + \pi}} \\
	&= A_0\abs{\sin\brak{2\pi f_0t}}
\end{align}
So the period of the function $x(t)$ is $\dfrac{1}{2f_0}$
\end{enumerate}
